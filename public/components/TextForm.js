...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}>
            ...
            <div className="mb-3">
                <textarea className="form-control" value={text} onChange={checkOnchange} style={{backgroundColor: props.mode==='dark'?'#16466e':'white', color: props.mode==='dark'?'white':'#042743'}} id="myText" rows="6"></textarea>
            </div>
            <div>
